(() => {
    ...
    const voiceSrc = './assets/images/spaces-v2/home-composer/voice.svg?v=send-icon-fix-1';
    const sendSrc = './assets/images/spaces-v2/home-composer/send.svg?v=send-icon-fix-1';
