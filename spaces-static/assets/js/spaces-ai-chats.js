(() => {
    ...
    const bubbleIcon = '/spaces-chat-ai/spaces-static/assets/images/sidebar/layout-aa/ai-chat-bubble.svg';
    const moreIcon = '/spaces-chat-ai/spaces-static/assets/images/sidebar/more.svg';
    ...
    const visibleChats = () => chats.slice(0, SIDEBAR_LIMIT);
    ...
    const DEMO_ARTIFACTS = [
        {
            ...
            type: 'Floor plan',
            previewUrl: '/spaces-chat-ai/spaces-static/assets/images/spaces-v2/inside-section-file.webp'
        },
        {
            ...
            type: 'Render',
            previewUrl: '/spaces-chat-ai/spaces-static/assets/images/spaces/card-image-1.webp'
        },
        {
            ...
            previewUrl: '/spaces-chat-ai/spaces-static/assets/images/spaces-v2/collection-preview.png'
        },
        {
